...
const IndexPage = () => {
    ...
    return (
        <Layout>
            ...
            <Page>
                <h2>Base64 Encode</h2>
                <textarea placeholder="Enter a string to encode" style={{ resize: 'none' }} ref={input} rows={5}></textarea>
                <button ref={button}>Encode String</button>
                <textarea readOnly placeholder="encoded string" style={{ resize: 'none' }} ref={result} rows={5}></textarea>
                <Code>
                    {`
